...
const char* PROFILE_UID_PATH = "/Canvas/Pages/PlayerProfilePage/GrpProfile/Right/GrpPlayerCard/UID/Layout/PlayerID";
const char* PROFILE_NAME_PATH = "/Canvas/Pages/PlayerProfilePage/GrpProfile/Right/GrpPlayerCard/Layout/PlayerName/TxtName";
const char* PROFILE_BIRTHDAY_PATH = "/Canvas/Pages/PlayerProfilePage/GrpProfile/Right/GrpPlayerCard/Layout/Birthday/TxtDate";
...
std::string SetupQuestBannerPattern = "41 57 41 56 56 57 55 53 48 81 EC ?? ?? ?? ?? 0F 29 BC 24 ?? ?? ?? ?? 0F 29 B4 24 ?? ?? ?? ?? 48 89 CE 0F 57 C0 0F 29 84 24 ?? ?? ?? ?? 0F 29 84 24";
...
//REL
std::string SetActivePattern = "E8 ?? ?? ?? ?? 41 8B 47 ?? 3D ?? ?? ?? ?? 0F 8D ?? ?? ?? ?? 49 8B 4E ?? 48 85 C9 0F 84 ?? ?? ?? ?? 48 8B 01 4C 89 FA 45 31 C0 FF 90";
//REL
std::string IsActivePattern = "E8 ?? ?? ?? ?? 84 C0 74 ?? 48 89 F1 E8 ?? ?? ?? ?? 48 8B 4E ?? 48 85 C9 0F 84 ?? ?? ?? ?? 80 79 ?? ?? 0F 94 C1 08 C1";
std::string EventCameraMovePattern = "41 57 41 56 56 57 55 53 48 83 EC ?? 48 89 D7 49 89 CE 80 3D ?? ?? ?? ?? ?? 0F 85 ?? ?? ?? ?? 80 3D ?? ?? ?? ?? ?? 0F 85 ?? ?? ?? ?? 49 8B 96";
std::string ShowOneDamageTextExPattern = "41 57 41 56 41 55 41 54 56 57 55 53 48 81 EC ?? ?? ?? ?? 44 0F 29 AC 24 ?? ?? ?? ?? 44 0F 29 A4 24 ?? ?? ?? ?? 44 0F 29 9C 24 ?? ?? ?? ?? 44 0F 29 94 24 ?? ?? ?? ?? 44 0F 29 8C 24 ?? ?? ?? ?? 44 0F 29 84 24 ?? ?? ?? ?? 0F 29 BC 24 ?? ?? ?? ?? 0F 29 B4 24 ?? ?? ?? ?? 44 89 CF";
//REL
...
std::string PlayerDiveMosaicPattern = "41 57 41 56 56 57 53 48 81 EC ?? ?? ?? ?? 48 89 CE 80 3D ?? ?? ?? ?? ?? 0F 85 ?? ?? ?? ?? 48 8B 86 ?? ?? ?? ?? 48 85 C0 0F 84 ?? ?? ?? ?? 8B 80 ?? ?? ?? ?? 48 83 F8";
std::string DisplayEffectPattern = "41 57 41 56 41 55 41 54 56 57 55 53 48 81 EC ?? ?? ?? ?? 0F 29 B4 24 ?? ?? ?? ?? 4C 89 CF 48 89 D6 49 89 CC 48 8B AC 24";
...
std::string CraftEntryPattern = "41 56 56 57 53 48 83 EC ?? 49 89 CE 80 3D ?? ?? ?? ?? ?? 0F 84 ?? ?? ?? ?? 80 3D ?? ?? ?? ?? ?? 48 8B 0D ?? ?? ?? ?? 0F 85 ?? ?? ?? ?? 48 8B 81 ?? ?? ?? ?? 48 85 C0 0F 84 ?? ?? ?? ?? 80 3D ?? ?? ?? ?? ?? 0F 85 ?? ?? ?? ?? 8B 90";
...
std::string OpenTeamPattern = "48 83 EC 28 80 3D ? ? ? ? 00 75 ? 48 8B 0D ? ? ? ? 80 B9 C7 00 00 00 00 74 ? B9 0C 00 00 00 E8 ? ? ? ? 84 C0 74";
//REL
...
std::string SetWaterMaskUIDPattern = "56 57 55 53 48 83 EC ?? 44 89 C5 48 89 D7 48 89 CB 80 3D ?? ?? ?? ?? ?? 0F 85 ?? ?? ?? ?? 48 89 D9 E8 ?? ?? ?? ?? 48 85 C0 0F 84 ?? ?? ?? ??";
std::string SetupPlayerProfilePagePattern = "55 41 57 41 56 41 55 41 54 56 57 53 48 81 EC ?? ?? ?? ?? 48 8D AC 24 ?? ?? ?? ?? 0F 29 75 ?? 48 C7 45 ?? ?? ?? ?? ?? 49 89 CC 80 3D ?? ?? ?? ?? ?? 0F 84 ?? ?? ?? ?? 80 3D ?? ?? ?? ?? ?? 48 8B 05 ?? ?? ?? ?? 0F 85 ?? ?? ?? ??";
std::string FastSkipTalkPattern = "56 57 48 83 EC 28 48 89 CE 80 3D ?? ?? ?? ?? 00 48 8B 05 ?? ?? ?? ?? 0F 85 ?? ?? ?? ?? 48 8B 88 ?? ?? ?? ?? 48 85 C9 0F 84 ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 8B 0D ?? ?? ?? ?? 48 85 C0 74";
